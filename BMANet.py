...
class BMANet(torch.nn.Module):
    def __init__(self):
        ...
        self.layer1 = AMPConv(in_channels=9,out_channels=64,edge_inchannels=3,hidden_channels=128)
        self.eu1 = BMA_update(node_channels=64,edge_channels=3,hidden_channels=128,out_channels=64)
        self.att_node1 = Sequential(Linear(64,64*4),ReLU(),Linear(64*4,64))
        self.att_edge1 = Sequential(Linear(64,64*4),ReLU(),Linear(64*4,64))

        self.layer2 = AMPConv(in_channels=64,out_channels=64,edge_inchannels=64,hidden_channels=512)
        self.eu2 = BMA_update(node_channels=64,edge_channels=64,hidden_channels=128,out_channels=64)
        self.att_node2 = Sequential(Linear(64,64*4),ReLU(),Linear(64*4,64))
        self.att_edge2 = Sequential(Linear(64,64*4),ReLU(),Linear(64*4,64))

        self.layer3 = AMPConv(in_channels=64,out_channels=64,edge_inchannels=64,hidden_channels=512)
        self.eu3 = BMA_update(node_channels=64,edge_channels=64,hidden_channels=128,out_channels=64)
        self.att_node3 = Sequential(Linear(64,64*4),ReLU(),Linear(64*4,64))
        self.att_edge3 = Sequential(Linear(64,64*4),ReLU(),Linear(64*4,64))

        self.layer4 = AMPConv(in_channels=64, out_channels=64, edge_inchannels=64, hidden_channels=512)
        self.eu4 = BMA_update(node_channels=64, edge_channels=64, hidden_channels=128, out_channels=64)
